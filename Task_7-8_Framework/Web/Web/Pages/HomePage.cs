...
namespace Web.Pages
{
    public class HomePage
    {
        ...
        public IList<IWebElement> AddPassenger { get; set; }
        ...
        public IWebElement GoArrivalCityButton { get; set; }
        [FindsBy(How = How.XPath, Using = "//input[@data-placeholder='Where to?']")]
        public IWebElement GoArrivalCityInput { get; set; }
        #endregion
        ...
        public IWebElement SuggestedTripsFromDepartureCity { get; set; }
        #endregion
        ...
        public IWebElement IsSign { get; set; }
        #endregion
